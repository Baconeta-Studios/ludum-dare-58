...
namespace Coherence.Generated
{
    ...
    public class Binding_1d3d32715f6d180429f58bb57f415d3b_bad3e9b144f24ef9aa5e14728682a150 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_1d3d32715f6d180429f58bb57f415d3b_e45a753fd694454782b05be1e43ccae6 : RotationBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_1d3d32715f6d180429f58bb57f415d3b : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_1d3d32715f6d180429f58bb57f415d3b>();
        ...
        {
			["bad3e9b144f24ef9aa5e14728682a150"] = new Binding_1d3d32715f6d180429f58bb57f415d3b_bad3e9b144f24ef9aa5e14728682a150(),
			["e45a753fd694454782b05be1e43ccae6"] = new Binding_1d3d32715f6d180429f58bb57f415d3b_e45a753fd694454782b05be1e43ccae6(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_1d3d32715f6d180429f58bb57f415d3b()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_1d3d32715f6d180429f58bb57f415d3b Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_1d3d32715f6d180429f58bb57f415d3b>();
            this.bridge = bridge;

...
namespace Coherence.Generated
{
    ...
    public class Binding_5c6cbc8172686a84f8ca2e6a7f732578_85e619b1b50a42d98d8d9dbb6c4940ed : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_5c6cbc8172686a84f8ca2e6a7f732578 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_5c6cbc8172686a84f8ca2e6a7f732578>();
        ...
        {
			["85e619b1b50a42d98d8d9dbb6c4940ed"] = new Binding_5c6cbc8172686a84f8ca2e6a7f732578_85e619b1b50a42d98d8d9dbb6c4940ed(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_5c6cbc8172686a84f8ca2e6a7f732578()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_5c6cbc8172686a84f8ca2e6a7f732578 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_5c6cbc8172686a84f8ca2e6a7f732578>();
            this.bridge = bridge;

...
namespace Coherence.Generated
{
    ...
    public struct _2e9a812656b76d04eb90df4854d1e30b_f6562890e480434592cf4279657526cd : IEntityCommand
    {
        ...
        public static unsafe _2e9a812656b76d04eb90df4854d1e30b_f6562890e480434592cf4279657526cd FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
            ...
            var orig = new _2e9a812656b76d04eb90df4854d1e30b_f6562890e480434592cf4279657526cd();
        ...
        public _2e9a812656b76d04eb90df4854d1e30b_f6562890e480434592cf4279657526cd(
            Entity entity,
        ...
        public static void Serialize(_2e9a812656b76d04eb90df4854d1e30b_f6562890e480434592cf4279657526cd commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _2e9a812656b76d04eb90df4854d1e30b_f6562890e480434592cf4279657526cd Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _2e9a812656b76d04eb90df4854d1e30b_f6562890e480434592cf4279657526cd()
            {
                Entity = entity,
                Routing = target,
                Target = target,

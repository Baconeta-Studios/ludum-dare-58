...
namespace Coherence.Generated
{
    ...
    public struct _323c83c22c66e134cafda906dd653efe_064fe0b81d1e40a1a083c4241981d580 : IEntityCommand
    {
        ...
        public static unsafe _323c83c22c66e134cafda906dd653efe_064fe0b81d1e40a1a083c4241981d580 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
            ...
            var orig = new _323c83c22c66e134cafda906dd653efe_064fe0b81d1e40a1a083c4241981d580();
        ...
        public _323c83c22c66e134cafda906dd653efe_064fe0b81d1e40a1a083c4241981d580(
            Entity entity,
        ...
        public static void Serialize(_323c83c22c66e134cafda906dd653efe_064fe0b81d1e40a1a083c4241981d580 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _323c83c22c66e134cafda906dd653efe_064fe0b81d1e40a1a083c4241981d580 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _323c83c22c66e134cafda906dd653efe_064fe0b81d1e40a1a083c4241981d580()
            {
                Entity = entity,
                Routing = target,
                Target = target,

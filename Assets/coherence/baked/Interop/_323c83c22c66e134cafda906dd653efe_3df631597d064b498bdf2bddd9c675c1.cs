...
namespace Coherence.Generated
{
    ...
    public struct _323c83c22c66e134cafda906dd653efe_3df631597d064b498bdf2bddd9c675c1 : IEntityCommand
    {
        ...
        public static unsafe _323c83c22c66e134cafda906dd653efe_3df631597d064b498bdf2bddd9c675c1 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
            ...
            var orig = new _323c83c22c66e134cafda906dd653efe_3df631597d064b498bdf2bddd9c675c1();
        ...
        public _323c83c22c66e134cafda906dd653efe_3df631597d064b498bdf2bddd9c675c1(
            Entity entity,
        ...
        public static void Serialize(_323c83c22c66e134cafda906dd653efe_3df631597d064b498bdf2bddd9c675c1 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _323c83c22c66e134cafda906dd653efe_3df631597d064b498bdf2bddd9c675c1 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _323c83c22c66e134cafda906dd653efe_3df631597d064b498bdf2bddd9c675c1()
            {
                Entity = entity,
                Routing = target,
                Target = target,

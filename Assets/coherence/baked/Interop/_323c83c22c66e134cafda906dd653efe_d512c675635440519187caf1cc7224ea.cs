...
namespace Coherence.Generated
{
    ...
    public struct _323c83c22c66e134cafda906dd653efe_d512c675635440519187caf1cc7224ea : IEntityCommand
    {
        ...
        public static unsafe _323c83c22c66e134cafda906dd653efe_d512c675635440519187caf1cc7224ea FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
            ...
            var orig = new _323c83c22c66e134cafda906dd653efe_d512c675635440519187caf1cc7224ea();
        ...
        public _323c83c22c66e134cafda906dd653efe_d512c675635440519187caf1cc7224ea(
            Entity entity,
        ...
        public static void Serialize(_323c83c22c66e134cafda906dd653efe_d512c675635440519187caf1cc7224ea commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _323c83c22c66e134cafda906dd653efe_d512c675635440519187caf1cc7224ea Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _323c83c22c66e134cafda906dd653efe_d512c675635440519187caf1cc7224ea()
            {
                Entity = entity,
                Routing = target,
                Target = target,

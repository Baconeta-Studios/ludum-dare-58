...
namespace Coherence.Generated
{
    ...
    public struct _323c83c22c66e134cafda906dd653efe_e1656a48232242a78a20782832d1f61a : IEntityCommand
    {
        ...
        public static unsafe _323c83c22c66e134cafda906dd653efe_e1656a48232242a78a20782832d1f61a FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
            ...
            var orig = new _323c83c22c66e134cafda906dd653efe_e1656a48232242a78a20782832d1f61a();
        ...
        public _323c83c22c66e134cafda906dd653efe_e1656a48232242a78a20782832d1f61a(
            Entity entity,
        ...
        public static void Serialize(_323c83c22c66e134cafda906dd653efe_e1656a48232242a78a20782832d1f61a commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _323c83c22c66e134cafda906dd653efe_e1656a48232242a78a20782832d1f61a Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _323c83c22c66e134cafda906dd653efe_e1656a48232242a78a20782832d1f61a()
            {
                Entity = entity,
                Routing = target,
                Target = target,

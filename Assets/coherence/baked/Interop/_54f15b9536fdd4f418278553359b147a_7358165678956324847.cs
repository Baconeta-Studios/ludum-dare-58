...
namespace Coherence.Generated
{
    ...
    public struct _54f15b9536fdd4f418278553359b147a_7358165678956324847 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.centerMask;
            centerSimulationFrame = frame;
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.sizeMask;
            sizeSimulationFrame = frame;
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.enabledMask;
            enabledSimulationFrame = frame;
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.isTriggerMask;
            isTriggerSimulationFrame = frame;
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.contactOffsetMask;
            contactOffsetSimulationFrame = frame;
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.hasModifiableContactsMask;
            hasModifiableContactsSimulationFrame = frame;
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.providesContactsMask;
            providesContactsSimulationFrame = frame;
            FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.layerOverridePriorityMask;
            layerOverridePrioritySimulationFrame = frame;
        }

        public static unsafe _54f15b9536fdd4f418278553359b147a_7358165678956324847 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 36) {
            ...
            var orig = new _54f15b9536fdd4f418278553359b147a_7358165678956324847();
        ...
        {
            var other = (_54f15b9536fdd4f418278553359b147a_7358165678956324847)data;
        ...
        public static uint Serialize(_54f15b9536fdd4f418278553359b147a_7358165678956324847 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                Coherence.Utils.Bounds.Check(data.layerOverridePriority, _layerOverridePriority_Min, _layerOverridePriority_Max, "_54f15b9536fdd4f418278553359b147a_7358165678956324847.layerOverridePriority", logger);
        ...
        public static _54f15b9536fdd4f418278553359b147a_7358165678956324847 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _54f15b9536fdd4f418278553359b147a_7358165678956324847();
            if (bitStream.ReadMask())
            {

                val.center = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.centerMask;
            }
            if (bitStream.ReadMask())
            {

                val.size = bitStream.ReadVector3(FloatMeta.NoCompression()).ToUnityVector3();
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.sizeMask;
            }
            if (bitStream.ReadMask())
            {

                val.enabled = bitStream.ReadBool();
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.enabledMask;
            }
            if (bitStream.ReadMask())
            {

                val.isTrigger = bitStream.ReadBool();
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.isTriggerMask;
            }
            if (bitStream.ReadMask())
            {

                val.contactOffset = bitStream.ReadFloat(FloatMeta.NoCompression());
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.contactOffsetMask;
            }
            if (bitStream.ReadMask())
            {

                val.hasModifiableContacts = bitStream.ReadBool();
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.hasModifiableContactsMask;
            }
            if (bitStream.ReadMask())
            {

                val.providesContacts = bitStream.ReadBool();
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.providesContactsMask;
            }
            if (bitStream.ReadMask())
            {

                val.layerOverridePriority = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _54f15b9536fdd4f418278553359b147a_7358165678956324847.layerOverridePriorityMask;
            }
        ...
        {
            return $"_54f15b9536fdd4f418278553359b147a_7358165678956324847(" +
                $" center: { this.center }" +
                $" size: { this.size }" +

...
namespace Coherence.Generated
{
    ...
    public struct _54f15b9536fdd4f418278553359b147a_bb4d88031fec41e383fc8c27a05fb58a : IEntityCommand
    {
        ...
        public static unsafe _54f15b9536fdd4f418278553359b147a_bb4d88031fec41e383fc8c27a05fb58a FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 50");
            }

            var orig = new _54f15b9536fdd4f418278553359b147a_bb4d88031fec41e383fc8c27a05fb58a();
        ...
        public _54f15b9536fdd4f418278553359b147a_bb4d88031fec41e383fc8c27a05fb58a(
            Entity entity,
        ...
        public static void Serialize(_54f15b9536fdd4f418278553359b147a_bb4d88031fec41e383fc8c27a05fb58a commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _54f15b9536fdd4f418278553359b147a_bb4d88031fec41e383fc8c27a05fb58a Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _54f15b9536fdd4f418278553359b147a_bb4d88031fec41e383fc8c27a05fb58a()
            {
                Entity = entity,
                Routing = target,
                Target = target,

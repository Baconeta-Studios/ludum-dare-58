...
namespace Coherence.Generated
{
    ...
    public struct _644fb43852fcb934c8446e7500c926a9_83734d47386d4e68b17e986b36f4e057 : IEntityCommand
    {
        ...
        public static unsafe _644fb43852fcb934c8446e7500c926a9_83734d47386d4e68b17e986b36f4e057 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 57");
            }

            var orig = new _644fb43852fcb934c8446e7500c926a9_83734d47386d4e68b17e986b36f4e057();
        ...
        public _644fb43852fcb934c8446e7500c926a9_83734d47386d4e68b17e986b36f4e057(
            Entity entity,
        ...
        public static void Serialize(_644fb43852fcb934c8446e7500c926a9_83734d47386d4e68b17e986b36f4e057 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _644fb43852fcb934c8446e7500c926a9_83734d47386d4e68b17e986b36f4e057 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _644fb43852fcb934c8446e7500c926a9_83734d47386d4e68b17e986b36f4e057()
            {
                Entity = entity,
                Routing = target,
                Target = target,

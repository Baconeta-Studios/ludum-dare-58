...
namespace Coherence.Generated
{
    ...
    public struct _644fb43852fcb934c8446e7500c926a9_de195482891146989d606cb9529889d0 : IEntityCommand
    {
        ...
        public static unsafe _644fb43852fcb934c8446e7500c926a9_de195482891146989d606cb9529889d0 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 60");
            }

            var orig = new _644fb43852fcb934c8446e7500c926a9_de195482891146989d606cb9529889d0();
        ...
        public _644fb43852fcb934c8446e7500c926a9_de195482891146989d606cb9529889d0(
            Entity entity,
        ...
        public static void Serialize(_644fb43852fcb934c8446e7500c926a9_de195482891146989d606cb9529889d0 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _644fb43852fcb934c8446e7500c926a9_de195482891146989d606cb9529889d0 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _644fb43852fcb934c8446e7500c926a9_de195482891146989d606cb9529889d0()
            {
                Entity = entity,
                Routing = target,
                Target = target,

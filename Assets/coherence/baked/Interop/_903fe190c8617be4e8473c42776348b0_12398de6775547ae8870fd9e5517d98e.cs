...
namespace Coherence.Generated
{
    ...
    public struct _903fe190c8617be4e8473c42776348b0_12398de6775547ae8870fd9e5517d98e : IEntityCommand
    {
        ...
        public static unsafe _903fe190c8617be4e8473c42776348b0_12398de6775547ae8870fd9e5517d98e FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 78");
            }

            var orig = new _903fe190c8617be4e8473c42776348b0_12398de6775547ae8870fd9e5517d98e();
        ...
        public _903fe190c8617be4e8473c42776348b0_12398de6775547ae8870fd9e5517d98e(
            Entity entity,
        ...
        public static void Serialize(_903fe190c8617be4e8473c42776348b0_12398de6775547ae8870fd9e5517d98e commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _903fe190c8617be4e8473c42776348b0_12398de6775547ae8870fd9e5517d98e Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _903fe190c8617be4e8473c42776348b0_12398de6775547ae8870fd9e5517d98e()
            {
                Entity = entity,
                Routing = target,
                Target = target,

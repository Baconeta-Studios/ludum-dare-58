...
namespace Coherence.Generated
{
    ...
    public struct _9f5bc27e05af2554b820330014ec60b3_cae968aaada94394b058c2b723d75f45 : IEntityCommand
    {
        ...
        public static unsafe _9f5bc27e05af2554b820330014ec60b3_cae968aaada94394b058c2b723d75f45 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 92");
            }

            var orig = new _9f5bc27e05af2554b820330014ec60b3_cae968aaada94394b058c2b723d75f45();
        ...
        public _9f5bc27e05af2554b820330014ec60b3_cae968aaada94394b058c2b723d75f45(
            Entity entity,
        ...
        public static void Serialize(_9f5bc27e05af2554b820330014ec60b3_cae968aaada94394b058c2b723d75f45 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _9f5bc27e05af2554b820330014ec60b3_cae968aaada94394b058c2b723d75f45 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _9f5bc27e05af2554b820330014ec60b3_cae968aaada94394b058c2b723d75f45()
            {
                Entity = entity,
                Routing = target,
                Target = target,

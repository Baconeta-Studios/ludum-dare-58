...
namespace Coherence.Generated
{
    ...
    public struct _a1fa7cddf5d5ef94b8bacf8838c9a6fa : IEntityInput, IEquatable<_a1fa7cddf5d5ef94b8bacf8838c9a6fa>
    {
        ...
        public static unsafe _a1fa7cddf5d5ef94b8bacf8838c9a6fa FromInterop(System.IntPtr data, System.Int32 dataSize)
        {
            if (dataSize != 0) {
        ...
        public _a1fa7cddf5d5ef94b8bacf8838c9a6fa(
        Entity entity,
        long frame,
        bool isRemoteInput)
        {
        ...
        public bool Equals(_a1fa7cddf5d5ef94b8bacf8838c9a6fa other)
        {
            return true;
        }

        public static void Serialize(_a1fa7cddf5d5ef94b8bacf8838c9a6fa inputData, IOutProtocolBitStream bitStream)
        {
        }

        public static _a1fa7cddf5d5ef94b8bacf8838c9a6fa Deserialize(IInProtocolBitStream bitStream, Entity entity, long frame)
        {

            return new _a1fa7cddf5d5ef94b8bacf8838c9a6fa()
            {
                Entity = entity,
                Frame = frame,
                isRemoteInput = true

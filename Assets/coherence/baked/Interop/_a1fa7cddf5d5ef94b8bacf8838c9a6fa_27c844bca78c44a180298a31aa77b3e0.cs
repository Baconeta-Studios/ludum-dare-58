...
namespace Coherence.Generated
{
    ...
    public struct _a1fa7cddf5d5ef94b8bacf8838c9a6fa_27c844bca78c44a180298a31aa77b3e0 : IEntityCommand
    {
        ...
        public static unsafe _a1fa7cddf5d5ef94b8bacf8838c9a6fa_27c844bca78c44a180298a31aa77b3e0 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 100");
            }

            var orig = new _a1fa7cddf5d5ef94b8bacf8838c9a6fa_27c844bca78c44a180298a31aa77b3e0();
        ...
        public _a1fa7cddf5d5ef94b8bacf8838c9a6fa_27c844bca78c44a180298a31aa77b3e0(
            Entity entity,
        ...
        public static void Serialize(_a1fa7cddf5d5ef94b8bacf8838c9a6fa_27c844bca78c44a180298a31aa77b3e0 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayerSync);
        }
        
        public static _a1fa7cddf5d5ef94b8bacf8838c9a6fa_27c844bca78c44a180298a31aa77b3e0 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayerSync = bitStream.ReadEntity();
    
            return new _a1fa7cddf5d5ef94b8bacf8838c9a6fa_27c844bca78c44a180298a31aa77b3e0()
            {
                Entity = entity,
                Routing = target,
                Target = target,

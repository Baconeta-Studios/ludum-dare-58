...
namespace Coherence.Generated
{
    ...
    public struct _a1fa7cddf5d5ef94b8bacf8838c9a6fa_34fddbd082cf40d0946240816f67bb36 : IEntityCommand
    {
        ...
        public static unsafe _a1fa7cddf5d5ef94b8bacf8838c9a6fa_34fddbd082cf40d0946240816f67bb36 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 8) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 8) " +
                    "for command with ID 62");
            }

            var orig = new _a1fa7cddf5d5ef94b8bacf8838c9a6fa_34fddbd082cf40d0946240816f67bb36();
        ...
        public _a1fa7cddf5d5ef94b8bacf8838c9a6fa_34fddbd082cf40d0946240816f67bb36(
            Entity entity,
        ...
        public static void Serialize(_a1fa7cddf5d5ef94b8bacf8838c9a6fa_34fddbd082cf40d0946240816f67bb36 commandData, IOutProtocolBitStream bitStream)
        {
        ...
        public static _a1fa7cddf5d5ef94b8bacf8838c9a6fa_34fddbd082cf40d0946240816f67bb36 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datastateNameHash = bitStream.ReadIntegerRange(32, -2147483648);
            var datalayer = bitStream.ReadIntegerRange(32, -2147483648);
    
            return new _a1fa7cddf5d5ef94b8bacf8838c9a6fa_34fddbd082cf40d0946240816f67bb36()
            {
                Entity = entity,
                Routing = target,
                Target = target,

...
namespace Coherence.Generated
{
    ...
    public struct _a1fa7cddf5d5ef94b8bacf8838c9a6fa_fedb9c11aaff482dafe28f87e3407817 : IEntityCommand
    {
        ...
        public static unsafe _a1fa7cddf5d5ef94b8bacf8838c9a6fa_fedb9c11aaff482dafe28f87e3407817 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 8) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 8) " +
                    "for command with ID 122");
            }

            var orig = new _a1fa7cddf5d5ef94b8bacf8838c9a6fa_fedb9c11aaff482dafe28f87e3407817();
        ...
        public _a1fa7cddf5d5ef94b8bacf8838c9a6fa_fedb9c11aaff482dafe28f87e3407817(
            Entity entity,
        ...
        public static void Serialize(_a1fa7cddf5d5ef94b8bacf8838c9a6fa_fedb9c11aaff482dafe28f87e3407817 commandData, IOutProtocolBitStream bitStream)
        {
        ...
        public static _a1fa7cddf5d5ef94b8bacf8838c9a6fa_fedb9c11aaff482dafe28f87e3407817 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datastateNameHash = bitStream.ReadIntegerRange(32, -2147483648);
            var datalayer = bitStream.ReadIntegerRange(32, -2147483648);
    
            return new _a1fa7cddf5d5ef94b8bacf8838c9a6fa_fedb9c11aaff482dafe28f87e3407817()
            {
                Entity = entity,
                Routing = target,
                Target = target,

...
namespace Coherence.Generated
{
    ...
    public struct _b34815fde6e38e64986379d4f1497883_eab2d28fa73a4ab18917dfc05da36608 : IEntityCommand
    {
        ...
        public static unsafe _b34815fde6e38e64986379d4f1497883_eab2d28fa73a4ab18917dfc05da36608 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 130");
            }

            var orig = new _b34815fde6e38e64986379d4f1497883_eab2d28fa73a4ab18917dfc05da36608();
        ...
        public _b34815fde6e38e64986379d4f1497883_eab2d28fa73a4ab18917dfc05da36608(
            Entity entity,
        ...
        public static void Serialize(_b34815fde6e38e64986379d4f1497883_eab2d28fa73a4ab18917dfc05da36608 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _b34815fde6e38e64986379d4f1497883_eab2d28fa73a4ab18917dfc05da36608 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _b34815fde6e38e64986379d4f1497883_eab2d28fa73a4ab18917dfc05da36608()
            {
                Entity = entity,
                Routing = target,
                Target = target,

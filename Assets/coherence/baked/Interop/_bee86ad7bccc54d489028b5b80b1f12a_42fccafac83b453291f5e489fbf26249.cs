...
namespace Coherence.Generated
{
    ...
    public struct _bee86ad7bccc54d489028b5b80b1f12a_42fccafac83b453291f5e489fbf26249 : IEntityCommand
    {
        ...
        public static unsafe _bee86ad7bccc54d489028b5b80b1f12a_42fccafac83b453291f5e489fbf26249 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 148");
            }

            var orig = new _bee86ad7bccc54d489028b5b80b1f12a_42fccafac83b453291f5e489fbf26249();
        ...
        public _bee86ad7bccc54d489028b5b80b1f12a_42fccafac83b453291f5e489fbf26249(
            Entity entity,
        ...
        public static void Serialize(_bee86ad7bccc54d489028b5b80b1f12a_42fccafac83b453291f5e489fbf26249 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _bee86ad7bccc54d489028b5b80b1f12a_42fccafac83b453291f5e489fbf26249 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _bee86ad7bccc54d489028b5b80b1f12a_42fccafac83b453291f5e489fbf26249()
            {
                Entity = entity,
                Routing = target,
                Target = target,

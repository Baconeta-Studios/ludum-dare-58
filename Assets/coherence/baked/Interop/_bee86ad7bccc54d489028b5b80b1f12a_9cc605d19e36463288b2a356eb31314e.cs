...
namespace Coherence.Generated
{
    ...
    public struct _bee86ad7bccc54d489028b5b80b1f12a_9cc605d19e36463288b2a356eb31314e : IEntityCommand
    {
        ...
        public static unsafe _bee86ad7bccc54d489028b5b80b1f12a_9cc605d19e36463288b2a356eb31314e FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 135");
            }

            var orig = new _bee86ad7bccc54d489028b5b80b1f12a_9cc605d19e36463288b2a356eb31314e();
        ...
        public _bee86ad7bccc54d489028b5b80b1f12a_9cc605d19e36463288b2a356eb31314e(
            Entity entity,
        ...
        public static void Serialize(_bee86ad7bccc54d489028b5b80b1f12a_9cc605d19e36463288b2a356eb31314e commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _bee86ad7bccc54d489028b5b80b1f12a_9cc605d19e36463288b2a356eb31314e Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _bee86ad7bccc54d489028b5b80b1f12a_9cc605d19e36463288b2a356eb31314e()
            {
                Entity = entity,
                Routing = target,
                Target = target,

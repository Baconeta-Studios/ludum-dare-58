...
namespace Coherence.Generated
{
    ...
    public struct _cd55199613c8b184e879d7bae921a108_07e377b8061c48f49f00e79e42ddbd09 : IEntityCommand
    {
        ...
        public static unsafe _cd55199613c8b184e879d7bae921a108_07e377b8061c48f49f00e79e42ddbd09 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 139");
            }

            var orig = new _cd55199613c8b184e879d7bae921a108_07e377b8061c48f49f00e79e42ddbd09();
        ...
        public _cd55199613c8b184e879d7bae921a108_07e377b8061c48f49f00e79e42ddbd09(
            Entity entity,
        ...
        public static void Serialize(_cd55199613c8b184e879d7bae921a108_07e377b8061c48f49f00e79e42ddbd09 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _cd55199613c8b184e879d7bae921a108_07e377b8061c48f49f00e79e42ddbd09 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _cd55199613c8b184e879d7bae921a108_07e377b8061c48f49f00e79e42ddbd09()
            {
                Entity = entity,
                Routing = target,
                Target = target,

...
namespace Coherence.Generated
{
    ...
    public struct _cd55199613c8b184e879d7bae921a108_1c3f13a17fcd4cff9582cc975c04c69b : IEntityCommand
    {
        ...
        public static unsafe _cd55199613c8b184e879d7bae921a108_1c3f13a17fcd4cff9582cc975c04c69b FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 140");
            }

            var orig = new _cd55199613c8b184e879d7bae921a108_1c3f13a17fcd4cff9582cc975c04c69b();
        ...
        public _cd55199613c8b184e879d7bae921a108_1c3f13a17fcd4cff9582cc975c04c69b(
            Entity entity,
        ...
        public static void Serialize(_cd55199613c8b184e879d7bae921a108_1c3f13a17fcd4cff9582cc975c04c69b commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _cd55199613c8b184e879d7bae921a108_1c3f13a17fcd4cff9582cc975c04c69b Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _cd55199613c8b184e879d7bae921a108_1c3f13a17fcd4cff9582cc975c04c69b()
            {
                Entity = entity,
                Routing = target,
                Target = target,

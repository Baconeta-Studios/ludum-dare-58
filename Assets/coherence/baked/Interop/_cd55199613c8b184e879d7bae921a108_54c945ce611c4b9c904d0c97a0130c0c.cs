...
namespace Coherence.Generated
{
    ...
    public struct _cd55199613c8b184e879d7bae921a108_54c945ce611c4b9c904d0c97a0130c0c : IEntityCommand
    {
        ...
        public static unsafe _cd55199613c8b184e879d7bae921a108_54c945ce611c4b9c904d0c97a0130c0c FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 157");
            }

            var orig = new _cd55199613c8b184e879d7bae921a108_54c945ce611c4b9c904d0c97a0130c0c();
        ...
        public _cd55199613c8b184e879d7bae921a108_54c945ce611c4b9c904d0c97a0130c0c(
            Entity entity,
        ...
        public static void Serialize(_cd55199613c8b184e879d7bae921a108_54c945ce611c4b9c904d0c97a0130c0c commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _cd55199613c8b184e879d7bae921a108_54c945ce611c4b9c904d0c97a0130c0c Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _cd55199613c8b184e879d7bae921a108_54c945ce611c4b9c904d0c97a0130c0c()
            {
                Entity = entity,
                Routing = target,
                Target = target,

...
namespace Coherence.Generated
{
    ...
    public struct _cd55199613c8b184e879d7bae921a108_7793c66d1c6e46aa8d87a365a825d864 : IEntityCommand
    {
        ...
        public static unsafe _cd55199613c8b184e879d7bae921a108_7793c66d1c6e46aa8d87a365a825d864 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 143");
            }

            var orig = new _cd55199613c8b184e879d7bae921a108_7793c66d1c6e46aa8d87a365a825d864();
        ...
        public _cd55199613c8b184e879d7bae921a108_7793c66d1c6e46aa8d87a365a825d864(
            Entity entity,
        ...
        public static void Serialize(_cd55199613c8b184e879d7bae921a108_7793c66d1c6e46aa8d87a365a825d864 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _cd55199613c8b184e879d7bae921a108_7793c66d1c6e46aa8d87a365a825d864 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _cd55199613c8b184e879d7bae921a108_7793c66d1c6e46aa8d87a365a825d864()
            {
                Entity = entity,
                Routing = target,
                Target = target,

...
namespace Coherence.Generated
{
    ...
    public struct _cd55199613c8b184e879d7bae921a108_eb005deffe204d2bb391cdd6924e0ca3 : IEntityCommand
    {
        ...
        public static unsafe _cd55199613c8b184e879d7bae921a108_eb005deffe204d2bb391cdd6924e0ca3 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 146");
            }

            var orig = new _cd55199613c8b184e879d7bae921a108_eb005deffe204d2bb391cdd6924e0ca3();
        ...
        public _cd55199613c8b184e879d7bae921a108_eb005deffe204d2bb391cdd6924e0ca3(
            Entity entity,
        ...
        public static void Serialize(_cd55199613c8b184e879d7bae921a108_eb005deffe204d2bb391cdd6924e0ca3 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _cd55199613c8b184e879d7bae921a108_eb005deffe204d2bb391cdd6924e0ca3 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _cd55199613c8b184e879d7bae921a108_eb005deffe204d2bb391cdd6924e0ca3()
            {
                Entity = entity,
                Routing = target,
                Target = target,

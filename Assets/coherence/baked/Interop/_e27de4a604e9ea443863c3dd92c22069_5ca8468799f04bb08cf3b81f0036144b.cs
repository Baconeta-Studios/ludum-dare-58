...
namespace Coherence.Generated
{
    ...
    public struct _e27de4a604e9ea443863c3dd92c22069_5ca8468799f04bb08cf3b81f0036144b : IEntityCommand
    {
        ...
        public static unsafe _e27de4a604e9ea443863c3dd92c22069_5ca8468799f04bb08cf3b81f0036144b FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 43");
            }

            var orig = new _e27de4a604e9ea443863c3dd92c22069_5ca8468799f04bb08cf3b81f0036144b();
        ...
        public _e27de4a604e9ea443863c3dd92c22069_5ca8468799f04bb08cf3b81f0036144b(
            Entity entity,
        ...
        public static void Serialize(_e27de4a604e9ea443863c3dd92c22069_5ca8468799f04bb08cf3b81f0036144b commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _e27de4a604e9ea443863c3dd92c22069_5ca8468799f04bb08cf3b81f0036144b Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _e27de4a604e9ea443863c3dd92c22069_5ca8468799f04bb08cf3b81f0036144b()
            {
                Entity = entity,
                Routing = target,
                Target = target,

...
namespace Coherence.Generated
{
    ...
    public struct _e61c5d2dfc4521841997842ff9788719_b29cf77c85a949cf95c7c84b649d2818 : IEntityCommand
    {
        ...
        public static unsafe _e61c5d2dfc4521841997842ff9788719_b29cf77c85a949cf95c7c84b649d2818 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 167");
            }

            var orig = new _e61c5d2dfc4521841997842ff9788719_b29cf77c85a949cf95c7c84b649d2818();
        ...
        public _e61c5d2dfc4521841997842ff9788719_b29cf77c85a949cf95c7c84b649d2818(
            Entity entity,
        ...
        public static void Serialize(_e61c5d2dfc4521841997842ff9788719_b29cf77c85a949cf95c7c84b649d2818 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _e61c5d2dfc4521841997842ff9788719_b29cf77c85a949cf95c7c84b649d2818 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _e61c5d2dfc4521841997842ff9788719_b29cf77c85a949cf95c7c84b649d2818()
            {
                Entity = entity,
                Routing = target,
                Target = target,

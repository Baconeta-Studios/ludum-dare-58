...
namespace Coherence.Generated
{
    ...
    public struct _e61c5d2dfc4521841997842ff9788719_b51ecda486b34706b4e3fd50e3588918 : IEntityCommand
    {
        ...
        public static unsafe _e61c5d2dfc4521841997842ff9788719_b51ecda486b34706b4e3fd50e3588918 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 168");
            }

            var orig = new _e61c5d2dfc4521841997842ff9788719_b51ecda486b34706b4e3fd50e3588918();
        ...
        public _e61c5d2dfc4521841997842ff9788719_b51ecda486b34706b4e3fd50e3588918(
            Entity entity,
        ...
        public static void Serialize(_e61c5d2dfc4521841997842ff9788719_b51ecda486b34706b4e3fd50e3588918 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _e61c5d2dfc4521841997842ff9788719_b51ecda486b34706b4e3fd50e3588918 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _e61c5d2dfc4521841997842ff9788719_b51ecda486b34706b4e3fd50e3588918()
            {
                Entity = entity,
                Routing = target,
                Target = target,

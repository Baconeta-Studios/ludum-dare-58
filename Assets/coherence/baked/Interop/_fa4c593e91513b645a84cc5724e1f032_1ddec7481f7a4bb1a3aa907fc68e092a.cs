...
namespace Coherence.Generated
{
    ...
    public struct _fa4c593e91513b645a84cc5724e1f032_1ddec7481f7a4bb1a3aa907fc68e092a : IEntityCommand
    {
        ...
        public static unsafe _fa4c593e91513b645a84cc5724e1f032_1ddec7481f7a4bb1a3aa907fc68e092a FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 171");
            }

            var orig = new _fa4c593e91513b645a84cc5724e1f032_1ddec7481f7a4bb1a3aa907fc68e092a();
        ...
        public _fa4c593e91513b645a84cc5724e1f032_1ddec7481f7a4bb1a3aa907fc68e092a(
            Entity entity,
        ...
        public static void Serialize(_fa4c593e91513b645a84cc5724e1f032_1ddec7481f7a4bb1a3aa907fc68e092a commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _fa4c593e91513b645a84cc5724e1f032_1ddec7481f7a4bb1a3aa907fc68e092a Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _fa4c593e91513b645a84cc5724e1f032_1ddec7481f7a4bb1a3aa907fc68e092a()
            {
                Entity = entity,
                Routing = target,
                Target = target,

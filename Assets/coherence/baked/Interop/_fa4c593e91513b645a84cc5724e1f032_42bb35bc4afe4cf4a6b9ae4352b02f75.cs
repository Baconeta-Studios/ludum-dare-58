...
namespace Coherence.Generated
{
    ...
    public struct _fa4c593e91513b645a84cc5724e1f032_42bb35bc4afe4cf4a6b9ae4352b02f75 : IEntityCommand
    {
        ...
        public static unsafe _fa4c593e91513b645a84cc5724e1f032_42bb35bc4afe4cf4a6b9ae4352b02f75 FromInterop(System.IntPtr data, System.Int32 dataSize) 
        {
            if (dataSize != 4) {
                throw new System.Exception($"Given data size is not equal to the struct size. ({dataSize} != 4) " +
                    "for command with ID 172");
            }

            var orig = new _fa4c593e91513b645a84cc5724e1f032_42bb35bc4afe4cf4a6b9ae4352b02f75();
        ...
        public _fa4c593e91513b645a84cc5724e1f032_42bb35bc4afe4cf4a6b9ae4352b02f75(
            Entity entity,
        ...
        public static void Serialize(_fa4c593e91513b645a84cc5724e1f032_42bb35bc4afe4cf4a6b9ae4352b02f75 commandData, IOutProtocolBitStream bitStream)
        {
            bitStream.WriteEntity(commandData.initiatingPlayer);
        }
        
        public static _fa4c593e91513b645a84cc5724e1f032_42bb35bc4afe4cf4a6b9ae4352b02f75 Deserialize(IInProtocolBitStream bitStream, Entity entity, MessageTarget target)
        {
            var datainitiatingPlayer = bitStream.ReadEntity();
    
            return new _fa4c593e91513b645a84cc5724e1f032_42bb35bc4afe4cf4a6b9ae4352b02f75()
            {
                Entity = entity,
                Routing = target,
                Target = target,
